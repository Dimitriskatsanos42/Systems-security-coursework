...
title_style = ParagraphStyle("TitleGR", parent=styles["Title"], fontSize=15, spaceAfter=3, leading=18)
h1 = ParagraphStyle("H1", parent=styles["Heading1"], fontSize=11.5, spaceBefore=8, spaceAfter=3, textColor=colors.HexColor("#1F4E79"))
h2 = ParagraphStyle("H2", parent=styles["Heading2"], fontSize=9.5, spaceBefore=5, spaceAfter=2, textColor=colors.HexColor("#2E6DA4"))
body = ParagraphStyle("BodyGR", parent=styles["Normal"], fontSize=8, leading=10.5, alignment=TA_LEFT, spaceAfter=3)
small = ParagraphStyle("SmallGR", parent=styles["Normal"], fontSize=7, leading=9, textColor=colors.HexColor("#444444"))
code_style = ParagraphStyle("Code", fontName="Courier", fontSize=6.3, leading=7.8, backColor=colors.HexColor("#f2f2f2"))
...
story.append(Paragraph("Secure File Storage System — Αναφορά Υλοποίησης", styles["Heading3"]))
